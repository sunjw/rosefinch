...
<div id="content">
    <div id="phpfmMessage" <?php if ($display_msg) print("style='display:block' ");
    if ($wrong) print("class='wrong' "); ?>>
        <?php
        if (!$ok)
    ...
    <form id="phpfmDatabaseForm" action="<?php echo get_URI(); ?>" method="post">
        ...
        <fieldset>
            ...
            <div>
                ...
                <input id="dbUser" type="text" maxlength="256" value="<?php echo $settings['db_user']; ?>"
                       name="dbUser"/>
                <div class="info">
            ...
            <div>
                ...
                <input id="dbName" type="text" maxlength="256" value="<?php echo $settings['db_name']; ?>"
                       name="dbName"/>
                <div class="info">
            ...
            <div>
                ...
                <input id="dbHost" type="text" maxlength="256" value="<?php echo $settings['db_host']; ?>"
                       name="dbHost"/>
                <div class="info">
